...
def DownloadVideo():
    ...
    #download function
    ytdError.config(text="Downloading...")
...
#Error Msg
ytdError = Label(root, text="Empty", fg="red", font=("jost",10))
ytdError.grid()
...
#developer Label
college = Label(root, text="R.R.S.D.C.E, Begusarai", font=("jost", 15))
college.grid()
developerlabel = Label(root, text="Project Contributers : \nRohit(17105125017)|Aaryan Raj(17105125024)|\nAnish(1710512508)|Rohit(17105125004)",font=("jost",15))
developerlabel.grid()
root.mainloop()